...
var I = { e2b: "https://huggingface.co/unsloth/gemma-4-E2B-it-GGUF/resolve/main/gemma-4-E2B-it-Q4_K_M.gguf" }, L = 256 * 1024 * 1024, R = globalThis.Float16Array, z = [
	...
	async init(e) {
		...
		this.tuning = s.profile, this.tuningReason = s.reason, this.mr4ForFfn = x(this.tuning, "ffn.linearGateUp") >= 4, this.weightQuant = e.weightQuant ?? "f16", this.weightQuant !== "f16" && (this.mr4ForFfn = !1), console.log(`[gemma4-webgpu] tuning: ${this.tuning.id} (${s.reason})${this.tuning.verified ? " — verified" : " — unverified"}`), this.reportProgress(0, 1, "Downloading header...", "downloading");
		let c = await fetch(r, {
	...
	dispatchMatmulRows(e, t) {
		let n = this.weightQuant === "q4k" ? 4 : 1;
		this.dispatchMatmul(e, Math.ceil(t / n));
	}
	...
	mmQuant(e, t, n, r, i) {
		let a = this.weightQuant === "q4k" ? this.pipelines.matmulQ4KMr : this.pipelines.matmulQ8;
		return this.device.createBindGroup({
	...
	encodeTransformerPass(e, t, n, r) {
		...
		if (h = this.beginPass(e, "embed"), h.setPipeline(this.pipelines.embeddingLookup), h.setBindGroup(0, this.bindGroupCache.embeddingLookup), h.dispatchWorkgroups(Math.ceil(a / 256)), h.end(), r?.kind !== "embed") {
			...
			for (let t = 0; t < i.num_layers; t++) {
				let n = this.bindGroupCache.layers[t], l = N(t, i), u = P(t, i), d = o * l, f = s * l, p = F(t, i), m = this.weightQuant === "q8" ? this.pipelines.matmulQ8 : this.weightQuant === "q4k" ? this.pipelines.matmulQ4KMr : this.pipelines.matmulQuant;
